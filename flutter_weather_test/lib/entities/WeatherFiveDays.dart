...
class CityWeatherFiveDays {
  ...
  factory CityWeatherFiveDays.fromRawJson(String str) =>
      CityWeatherFiveDays.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory CityWeatherFiveDays.fromJson(Map<String, dynamic> json) =>
      CityWeatherFiveDays(
        cod: json["cod"],
  ...
  void then(void Function(dynamic value) param0) {}
}
